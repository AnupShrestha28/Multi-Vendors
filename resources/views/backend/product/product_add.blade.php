               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input name="product_thambnail" type="file" class="form-control" id="formFile">
                  </div>

                  <div class="mb-3">
                    <label for="inputProductTitle" class="form-label">Multiple Image</label>
                    <input type="file" class="form-control" name="multi_img[]" id="formFileMultiple" multiple="">
                  </div>
                </div>
               </div>
               <div class="col-lg-4">
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <div class="col-12">
                        ...
                        <select name="subactegory_id" class="form-select" id="inputCollection">
                            <option></option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
